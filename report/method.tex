...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{feature_tree}
...
\begin{figure}[htp]
    ...
    It is likily that this is not good samples or this can also be pervieved as listening to two different birds at the same time.]{
